...
class Qotd(Base):
    ...
    async def on_message(self, message: discord.Message):
        ...
        if "QOTD" in message.content.upper():
            ...
            try:
                ...
                await self.log_event("error", f"Failed to send QOTD help: {e}")
    ...
    async def daily_qotd_loop(self):
        try:
            ...
            await self.log_event("error", f"Daily QOTD task failed: {e}")
    ...
    async def fetch(self, interaction: discord.Interaction, num: int):
        ...
        try:
            ...
            await self.log_event("error", f"Fetch command failed: {e}")
    ...
    async def solution(self, interaction: discord.Interaction, num: int, link: str = ""):
        ...
        try:
            ...
            await self.log_event("error", f"Solution command failed: {e}")
    ...
    async def submit(self, interaction: discord.Interaction, answer: str, num: Optional[int] = None):
        ...
        try:
            ...
            await self.log_event("error", f"Submit command failed: {e}")
    ...
    async def upload(self, interaction: discord.Interaction, question_links: str, topic: str, answer: str, difficulty: str, tolerance: str = "1", source: str = "", points: str = ""):
        ...
        try:
            ...
            try:
                ...
                await self.log_event("error", f"QOTD Upload ValueError: {e}")
            ...
            await self.log_event("error", f"Upload command failed: {e}")
    ...
    async def update_leaderboard(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await self.log_event("error", f"Leaderboard update failed: {e}")
    ...
    async def status(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await self.log_event("error", f"Status command failed: {e}")
    ...
    async def merge(self, interaction: discord.Interaction, num: int, add: bool = True):
        ...
        try:
            ...
            await self.log_event("error", f"Merge command failed: {e}")
    ...
    async def remove(self, interaction: discord.Interaction, num: int):
        ...
        try:
            ...
            await self.log_event("error", f"Remove command failed: {e}")
